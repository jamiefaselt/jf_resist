...
mt.wy.repub.avg <- merge(mt.rep.avg.rast, wy.rep.avg.rast)
plot(mt.wy.repub.avg)
writeRaster(mt.wy.repub.avg, "Raster_Layers/mtwy_avgrepub_00-20.tif")
mt.wy.2020 <- merge(mt.2020.rast, wy.2020.rast)
plot(mt.wy.2020)
